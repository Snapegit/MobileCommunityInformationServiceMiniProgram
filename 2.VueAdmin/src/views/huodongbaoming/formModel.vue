		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="参加人数" prop="renshu">
							<el-input class="list_inp" v-model.number="form.renshu" placeholder="参加人数"
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			form.value.renshu = 0
			disabledForm.value.renshu = false;
			form.value.renshu='1'
			form.value.sfsh='待审核'
			formVisible.value = true
		}
	...
	const save=()=>{
		...
		if(!!objcross) {
			objcross.renshu = parseFloat(objcross.renshu) + parseFloat(form.value.renshu)
		}
		let crossUserId = ''
		let crossRefId = ''
		let crossOptNum = ''
